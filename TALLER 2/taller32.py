...
productos_disponibles = int(input("Digite la cantidad de productos que hay disponibles :"));
...
ambos_cursos = len(productos_disponibles_vendidos);
...
cantidadc = len(productos_han_devuelto_disponibles);
...
cantidadc = len(productos_disponibles_no_vendidos);

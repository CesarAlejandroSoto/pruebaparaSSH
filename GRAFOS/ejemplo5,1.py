...
class Grafo:
    ...
    def ruta_cortadijkstra(self, source):
        shortest_path = nx.dijkstra_path(self.grafo, source=source, weight="weight")
        print("Ruta más corta:", shortest_path)
        
    def distancia_dijkstra(self, source, target):
        distance = nx.dijkstra_path_length(self.grafo, source=source, target=target, weight="weight")
...
print("Ruta más corta con Dijkstra")
grafo.ruta_cortadijkstra('Rioacha')

print("Distancia más corta con Dijkstra")
grafo.distancia_dijkstra('Rioacha', 'Tolu')
